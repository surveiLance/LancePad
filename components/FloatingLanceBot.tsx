...
const PAGE_QUIPS: Record<string, string[]> = {
  notebooks: [
    "Pick a notebook. Let the brain soup begin 📚",
    "Sige, open one. I brought imaginary highlighters.",
    "One notebook. Tiny academic side quest.",
    "Study now, panic monster gets weaker.",
    "Future you just sent a thankful nod.",
    "Let's study. The neurons are stretching.",
    "I'm here, politely haunting your productivity 👀",
    "Tiny step. Big brain receipt later.",
    "Tara, start one. Low drama, high yield.",
    "Those notebooks are waiting like unopened quests.",
  ],
  cards: [
    "Generate cards when ready. I shall shuffle the knowledge 👀",
    "Flashcards? Tiny brain dumbbells 🧠",
    "One card, one concept. Very tidy.",
    "Review a few. Kaya yan, champion of rectangles 💪",
    "Add cards now, interrogate them later 📇",
    "Cards are a good move. Suspiciously responsible 🤌",
    "Card count looks healthy. Very academic snack.",
  ],
  quizzes: [
    "Review past quizzes. The receipts are useful 👀",
    "Wrong answers are clues in tiny disguises 🗺️",
    "Quiz history. Character development detected 😤",
    "Mistakes = free reviewers. Annoying, but generous.",
    "Check the scores. No judgment, just data 📈",
    "See what needs another pass. We hunt confusion politely.",
  ],
  study: [
    "One question at a time. No brain stampede 💜",
    "Think it through. Let the neurons assemble.",
    "Make this one count. Tiny fireworks pending 🎉",
    "Read carefully. The trick words wear tiny hats 🤔",
    "Practice now, future-you flexes later.",
    "Wrong answer? Useful data wearing a fake mustache.",
    "I believe in you. Fr, no inspirational poster needed.",
    "Take your time. Speedrun later.",
    "You know more than you think. The filing system is just messy.",
    "Wrong means we learn. Annoying but effective.",
    "Fast is good. Accurate is the final boss.",
    "Laban. Academic mode engaged 💪",
  ],
  tutor: [
    "Ask away. I ate the notes, academically 📖",
    "No dumb questions here. Sige, send the suspicious one.",
    "Built for this exact tiny crisis 🎓",
    "Still fuzzy? I can re-explain with a weirder analogy.",
    "I explain. That's my whole enchanted briefcase.",
    "Stuck? I'm here with a tiny flashlight 💜",
    "I read the notes. Probably with dramatic lighting.",
    "Send the question. I am emotionally prepared 😤",
    "Ask the awkward question. Those are usually the useful ones.",
    "Safe study zone. Confusion may enter, shame may not 💜",
  ],
};

const TYPING_QUIPS = {
  justStarted: [
    "Uy, you started. The page has awakened 📝",
    "Momentum acquired. Tiny engine noises 👁️",
    "Sige, dump the notes. I will sort the academic laundry 📋",
  ],
  short: [
    "Add a bit more. The notes are still in appetizer mode 😬",
    "More detail helps. Feed the study machine 💪",
    "A few more notes and this starts cooking.",
  ],
  medium: [
    "Enough to generate. The flashcard forge is warm 🃏",
    "Solid notes. Respectfully nerdy 🫡",
    "Good material here. Brain pantry stocked 🧠",
  ],
  long: [
    "Lots of notes. Respect, scholar with a keyboard 😭",
    "Still reading. There is lore here 👁️",
    "Useful notes. The study buffet is open.",
  ],
  paused: [
    "Paused? All good. The thoughts are marinating 💜",
    "Thinking is allowed. Very premium feature 🤔",
    "Generate when ready. I am hovering respectfully 🫶",
    "Looks ready. The button is quietly flexing ⚡",
    "Breathe. Continue. We are not being chased 💪",
  ],
  keywords: [
    { words: ["history", "kasaysayan", "historical"], quip: "History. Dusty timeline mode 📜" },
    { words: ["math", "equation", "algebra", "calculus"], quip: "Math? Sige, number jungle time 🔢" },
    { words: ["science", "biology", "chemistry", "physics"], quip: "Science notes. Tiny lab coat moment 🔬" },
    { words: ["english", "literature", "essay", "grammar"], quip: "English notes. The commas are watching 📖" },
    { words: ["law", "legal", "constitution", "rights"], quip: "Law notes. Objection: useful 📃" },
    { words: ["economics", "econ", "supply", "demand"], quip: "Economics time. Invisible hand waving 🏦" },
    { words: ["filipino", "pilipino", "tagalog", "wika"], quip: "Filipino subject. Ayos, wika mode 🇵🇭" },
    { words: ["nursing", "medical", "anatomy", "health"], quip: "Medical notes. Tiny stethoscope energy 🩺" },
    { words: ["programming", "code", "function", "algorithm"], quip: "Code notes. Bugs are sweating 💻" },
  ],
};
